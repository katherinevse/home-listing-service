# Сервис домов
Ежедневно в любом сервисе недвижимости публикуются тысячи объявлений о продаже или аренде. Они попадают в каталог домов, в котором пользователь может выбрать жильё по нужным параметрам в понравившемся доме. 
Прежде чем попасть в каталог, объявление проходит тщательную модерацию, чтобы в нём не было недопустимого контента. 


## Для реализации данного сервиса я создала доску миро, которой пользовалась в момент разработки:
**Ссылка на Miro для разработки: https://miro.com/app/board/uXjVLe9m1Lc=/?share_link_id=432262272261**

## Описание задачи 

Разработайте backend-сервис, с помощью которого пользователь сможет продать квартиру, загрузив объявление. 
### Функционал сервиса: 
